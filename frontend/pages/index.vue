<template>
  ...
  <AdminTemplate :page="page" :modulo="modulo">
                 ...
                 <div class="row">
                   <div class="col-lg-6">
                     <div class="d-flex flex-column h-100">
                       <p class="mb-1 pt-2 text-bold">¿Quienes somos?</p>
                       <h5 class="font-weight-bolder">Electronica Raynet, S.A.</h5>
                       <p class="mb-5">
                        Ventas de repuesto, linea marron y linea blanca, autorizados de la marca LG.
                       </p>
                       <a
                   ...
                   <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                     <div class="bg-gradient-primary border-radius-lg h-100">
                       <img
                         src="/assets/img/shapes/Ersa.jpg"
                         class="position-absolute h-100 w-40 top-0 d-lg-block d-none"
                         alt="waves"
                       />
                       <div
     ...
     style="background-image: url('/assets/img/shapes/Lg_logo.jpg'); background-position: center center;">
